export const colors = {
  ...
  export const MALLA_IMAGE_MAX_HEIGHT = '550px';
  
  export const monthlyReportsData = [
    { month: 'Cargas Horarias 1er Semestre 2026', num: '', driveLink: 'https://drive.google.com/drive/folders/1iTNoecDAViwCfjOlTOTQ6vvKqa8EAOIa', isSpecial: true },
    ...
    { month: 'Cargas Horarias 2do Semestre 2026', num: '', driveLink: 'https://drive.google.com/drive/folders/1UQjwPWsXoVLokLqBvGOe369sYytVO7My', isSpecial: true },
  ...
  export const centralizadoresData = [
    { title: 'Centralizadores Semestrales', desc: 'Calificaciones consolidadas del 1er y 2do semestre.', type: 'Semestral', link: 'https://drive.google.com/drive/folders/1M-JvgfmSYD8RoTMIuTfWVPldLjXNGAm7' },
    { title: 'Centralizadores Anuales', desc: 'Calificaciones de materias con modalidad anual.', type: 'Anual', link: 'https://drive.google.com/drive/folders/1_Lnsfu7CxiQOKQ8rXo9Vc7goT2uKi1as' },
  ];
